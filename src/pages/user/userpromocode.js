...
const UserPromoCodePage = ({ role, loggedInUser }) => {
  ...
  const fetchOrganisations = async () => {
    try {
      const res = await axios.get("http://Localhost:5000/api/organisation");
  ...
  const fetchCategories = async (orgId) => {
    try {
      const res = await axios.get(
        `http://Localhost:5000/api/organisation/${orgId}/categories`
      );
  ...
  const fetchPercentage = async (orgId, catId) => {
    try {
      const res = await axios.get(
        `http://Localhost:5000/api/organisation/${orgId}/categories/${catId}/percentage`
      );
      setPercentage(
  ...
  const handleGetPromoCode = async () => {
    ...
    try {
      const res = await axios.get(
        `http://Localhost:5000/api/organisation/${selectedOrganisationId}/promo-codes/unused`
      );
  ...
  const handleSave = async () => {
    try {
      const res = await axios.post("http://Localhost:5000/api/user-promo-codes", {
